...
def main():
    ...
    save_geometry_diagnostics(model, out_dir, "Scissor_Bridge_2_Load")
    ...
    save_figure(model.plots.Plot_Shape_Bar_Stress(truss_stress),
                os.path.join(out_dir, "Scissor_Bridge_2_Load_Bar_Stress.png"))
    save_figure(model.plots.Plot_Shape_Bar_Failure(passYN),
                os.path.join(out_dir, "Scissor_Bridge_2_Load_Bar_Failure.png"))
    save_figure(model.plots.Plot_Deformed_Shape(U_end),
                os.path.join(out_dir, "Scissor_Bridge_2_Load_Deformed.png"))
    save_figure(model.plots.Plot_Deformed_Shape(U_end),
                os.path.join(out_dir, "Scissor_Bridge_2_Fully_Deployed_Load_Deformed.png"))
