...
from AREMA_common import print_arema_local_screen
from scissor_common import bridge_self_weight, build_scissor_model, load_supports


def improvedScissor_e80_service_arema(secNum, include_impact=True, train_step_m=None):
...
improvedScissor_e80_service = improvedScissor_e80_service_arema
