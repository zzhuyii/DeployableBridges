...
if BridgeType=='kirigami':        
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")  
    st.write(f"The the maximum load kirigami bridge can carry is: {F/1000} kN")
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")  
    st.write(f"The the maximum load origami bridge can carry is: {F/1000} kN")
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")   
    st.write(f"The the maximum load scissor bridge can carry is: {F/1000} kN")
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")    
    st.write(f"The the maximum load improved scissor bridge can carry is: {F/1000} kN")
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png") 
    st.write(f"The the maximum load rolling bridge can carry is: {F/1000} kN")
