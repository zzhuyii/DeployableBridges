...
if BridgeType=='kirigami':        
    ...
    st.write(f"The tip deflection of kirigami bridge is: {tip*1000:.2f} mm")
    st.pyplot(fig1)
    st.pyplot(fig2)
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")  
    st.write(f"The tip deflection of origami bridge is: {tip*1000:.2f} mm")
    st.pyplot(fig1)
    st.pyplot(fig2)
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")    
    st.write(f"The tip deflection of scissor bridge is: {tip*1000:.2f} mm")
    st.pyplot(fig1)
    st.pyplot(fig2)
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")   
    st.write(f"The tip deflection of improved scissor bridge is: {tip*1000:.2f} mm")
    st.pyplot(fig1)
    st.pyplot(fig2)    
    ...
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Failure.png")
    # st.image("Kirigami_Truss_Strength_During_Deploy_Bar_Stress.png")  
    st.write(f"The tip deflection of rolling bridge is: {tip*1000:.2f} mm")
    st.pyplot(fig1)
    st.pyplot(fig2)          
